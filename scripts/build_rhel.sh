...
export OMNIBUS_BUILD_OPTIONS="-l internal --override cache_suffix:$PROJECT_NAME fatal_licensing_warnings:true cache_suffix:$PROJECT_NAME append_timestamp:false"
